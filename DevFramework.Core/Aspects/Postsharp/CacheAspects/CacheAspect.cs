...
namespace DevFramework.Core.Aspects.Postsharp.CacheAspects
{
    ...
    public class CacheAspect : MethodInterceptionAspect
    {
        ...
        private int _cacheDurationMins;
        private ICacheManager _cacheManager;

        public CacheAspect(Type cacheType, int cacheDurationMins = 60)
        {
            _cacheType = cacheType;
            _cacheDurationMins = cacheDurationMins;
        }
        ...
        public override void OnInvoke(MethodInterceptionArgs args)
        {
            ...
            base.OnInvoke(args);
            _cacheManager.Add(key, args.ReturnValue, _cacheDurationMins);
        }
    }
}
